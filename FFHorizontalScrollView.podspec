Pod::Spec.new do |s|
  ...
  s.source_files = "FFHorizontalScroll/FFHorizontalScrollView/Core", "FFHorizontalScroll/FFHorizontalScrollView/Core/*.{h, a}", "FFHorizontalScroll/FFHorizontalScrollView/Resources", "FFHorizontalScroll/FFHorizontalScrollView/Resources/*.bundle" 
